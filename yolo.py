...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        out_data = (out_boxes, out_scores, out_classes)
        return out_data
        # print('Found {} boxes for {}'.format(len(out_boxes), 'img'))

    def draw(self, image, video_fr,  detect_data, select_label):
        out_boxes, out_scores, out_classes = detect_data
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if select_label and predicted_class != select_label:
                continue
            box = out_boxes[i]
            score = out_scores[i]
